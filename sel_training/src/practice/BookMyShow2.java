...
public class BookMyShow2 {
	...
	public static void main(String[] args) throws InterruptedException {
		  ...
		  try 
		  {
		  //driver.switchTo().frame(driver.findElement(By.className("wzrk-alert wiz-show-animate")));
		  ...
		  Thread.sleep(2000);
		  List<WebElement> oelelist = driver.findElements(By.xpath("//*[@id='now-showing']/section[1]/div/div[2]/div[2]/div"));
		  int t = oelelist.size();
		  ...
		  //System.out.println(e1.getText());
		    ...
		    System.out.println("Value is  "+e1.getText()+" test ");
